        ...
        if (header != null && header.startsWith(BEARER_PREFIX)) {
            ...
            try {
                ...
                if (!JwtVerifier.TOKEN_TYPE_ACCESS.equals(claims.get(JwtVerifier.CLAIM_TOKEN_TYPE, String.class))) {
                    request.setAttribute(TOKEN_ERROR_ATTRIBUTE, JwtAuthErrorCode.invalidToken("CHAT_003"));
                ...
                request.setAttribute(TOKEN_ERROR_ATTRIBUTE, JwtAuthErrorCode.tokenExpired("CHAT_002"));
                SecurityContextHolder.clearContext();
